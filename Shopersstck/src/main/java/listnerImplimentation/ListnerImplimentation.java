...
public class ListnerImplimentation implements ITestListener,ISuiteListener
{
	...
	{
		String imgpath="./FailedScreenshot/" + result.getName() + ".png";
	...
	public void onTestSkipped(ITestResult result)
	{
		...
		test.log(LogStatus.SKIP, result.getName()+ "has Sipped Successfully");
	}
	public void onFinish(ISuite suite)
	{
		Reporter.log(suite.getName()+"has Finshed", true);
		test.log(LogStatus.INFO, suite.getName()+"had Finished");
		report.endTest(test);
		report.flush();
	}
}
